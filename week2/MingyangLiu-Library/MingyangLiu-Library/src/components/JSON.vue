  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <!-- Activity 9: Render a list of Austen's works. 
       Hint: Use the v-for directive to iterate through the array of authors that you have filtered out. -->
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="(count, type) in bookstores.storeTypes" :key="bookstores.type">
          {{ type }} : {{ count }}
        </li>
      </ul>
      ...
      <!-- Activity 11: Iterate through the openingHours object 
       and display the day of the week and the opening and closing times. -->
...
//   return austen?.famousWorks.map((work) => work.title)
// })
</script>
